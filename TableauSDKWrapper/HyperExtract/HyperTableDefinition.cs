...
namespace TableauSDKWrapper.Hyper
{
    ...
    public class TableDefinition : IDisposable
    {
        ...
        {
            Int32 result = HyperTableDefinitionNative.Create(out m_Handle);
        ...
        public void Close()
        {
            ...
            {
                Int32 result = HyperTableDefinitionNative.Close(m_Handle);
        ...
        {
            Int32 retval;
            Int32 result = HyperTableDefinitionNative.GetDefaultCollation(m_Handle, out retval);
            Util.CheckResult(result);
        ...
        {
            Int32 result = HyperTableDefinitionNative.SetDefaultCollation(m_Handle, collation.ToInt());
            Util.CheckResult(result);
        }
        ...
        {
            Int32 result = HyperTableDefinitionNative.AddColumn(m_Handle, name, type.ToInt());
            Util.CheckResult(result);
        }
        ...
        {
            Int32 result = HyperTableDefinitionNative.AddColumnWithCollation(m_Handle, name, type.ToInt(), collation.ToInt());
            Util.CheckResult(result);
        }
        ...
        {
            Int32 retval;
            Int32 result = HyperTableDefinitionNative.GetColumnCount(m_Handle, out retval);
            Util.CheckResult(result);
        ...
        {
            IntPtr namePtr;
            Int32 result = HyperTableDefinitionNative.GetColumnName(m_Handle, columnNumber, out namePtr);
            Util.CheckResult(result);
        ...
        {
            Int32 retval;
            Int32 result = HyperTableDefinitionNative.GetColumnType(m_Handle, columnNumber, out retval);
            Util.CheckResult(result);
        ...
        {
            Int32 retval;
            Int32 result = HyperTableDefinitionNative.GetColumnCollation(m_Handle, columnNumber, out retval);
            Util.CheckResult(result);
