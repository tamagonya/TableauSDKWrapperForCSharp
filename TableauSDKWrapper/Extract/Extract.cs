...
namespace TableauSDKWrapper.Extract
{
    ...
    public class Extract : IDisposable
    {
        ...
        /// </summary>
        /// <param name="path">The path and file name of the extract file to create or open. The path must include the ".tde" extension.</param>
        public Extract(String path)
        {
            Int32 result = ExtractNative.Create(out m_Handle, path);
        ...
        public void Close()
        {
            ...
            {
                Int32 result = ExtractNative.Close(m_Handle);
        ...
        public Table AddTable(String name, TableDefinition tableDefinition)
        {
            ...
            Int32 result = ExtractNative.AddTable(m_Handle, name, tableDefinition.Handle, out retval);
            Util.CheckResult(result);
        ...
        {
            IntPtr retval = IntPtr.Zero;
            Int32 result = ExtractNative.OpenTable(m_Handle, name, out retval);
            Util.CheckResult(result);
        ...
        {
            Int32 retval;
            Int32 result = ExtractNative.HasTable(m_Handle, name, out retval);
            Util.CheckResult(result);
