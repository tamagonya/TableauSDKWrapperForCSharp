...
namespace TableauSDKWrapper.Extract
{
    ...
    public class Row : IDisposable
    {
        ...
        {
            Int32 result = RowNative.Create(out m_Handle, tableDefinition.Handle);
        ...
        public void Close()
        {
            ...
            {
                Int32 result = RowNative.Close(m_Handle);
        ...
        {
            Int32 result = RowNative.SetNull(m_Handle, columnNumber);
            Util.CheckResult(result);
        }
        ...
        {
            Int32 result = RowNative.SetInteger(m_Handle, columnNumber, value);
            Util.CheckResult(result);
        }
        ...
        {
            Int32 result = RowNative.SetLongInteger(m_Handle, columnNumber, value);
            Util.CheckResult(result);
        }
        ...
        {
            Int32 result = RowNative.SetDouble(m_Handle, columnNumber, value);
            Util.CheckResult(result);
        }
        ...
        {
            Int32 result = RowNative.SetBoolean(m_Handle, columnNumber, value ? 1 : 0);
            Util.CheckResult(result);
        }
        ...
        {
            Int32 result = RowNative.SetString(m_Handle, columnNumber, value);
            Util.CheckResult(result);
        }
        ...
        {
            Int32 result = RowNative.SetCharString(m_Handle, columnNumber, value.ToStringBuilder());
            Util.CheckResult(result);
        }
        ...
        {
            Int32 result = RowNative.SetDate(m_Handle, columnNumber, year, month, day);
            Util.CheckResult(result);
        }
        ...
        {
            Int32 result = RowNative.SetDateTime(m_Handle, columnNumber, year, month, day, hour, min, sec, frac);
            Util.CheckResult(result);
        }
        ...
        {
            Int32 result = RowNative.SetDuration(m_Handle, columnNumber, day, hour, min, sec, frac);
            Util.CheckResult(result);
        }
        ...
        {
            Int32 result = RowNative.SetSpatial(m_Handle, columnNumber, value.ToStringBuilder());
            Util.CheckResult(result);
        }
    }
}
